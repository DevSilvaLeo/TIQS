...
import { IDetalhesProps } from './IDetalhesProps';
...
export default class Detalhes extends React.Component<IDetalhesProps, {}> {
  ...
  public render(): React.ReactElement<IDetalhesProps> {
    return (
      <>
