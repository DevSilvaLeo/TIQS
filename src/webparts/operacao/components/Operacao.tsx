...
import { IOperacaoProps } from './IOperacaoProps';
import { escape } from '@microsoft/sp-lodash-subset';

import 'bootstrap/dist/css/bootstrap.css';
import '../../../css/style.css';

export default class Operacao extends React.Component<IOperacaoProps, {}> {
  public render(): React.ReactElement<IOperacaoProps> {
    return (
      ...
      <div className="container" data-aos="fade-up">
        <div className="row separator">
          <div className="col-xl-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <a href={'https://fabricatheone.sharepoint.com/sites/LindeDigital/SitePages/Detalhes.aspx?IdItem=5'}>
              <div className="icon-box">
                {/* <div className="icon"><i className="bx bxl-dribbble"></i></div> */}
                <h4>Projeto: WM GerenciAR (APP RTU)</h4>
          ...
          <div className="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <a href={'https://fabricatheone.sharepoint.com/sites/LindeDigital/SitePages/Detalhes.aspx?IdItem=6'}>
              <div className="icon-box">
                {/* <div className="icon"><i className="bx bx-file"></i></div> */}
                <h4><a href="">Projeto 2</a></h4>
